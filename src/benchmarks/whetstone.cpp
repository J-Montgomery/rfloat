/* Benchmark derived from the Ansibench Whetstone test, with modifications
 * made to support C++ and type aliases for use in this library
 */
/*
 * C Converted Whetstone float_type Precision Benchmark
...
/*
C**********************************************************************
C     Benchmark #2 -- float_type  Precision Whetstone (A001)
C
...
/* function prototypes */
void POUT(long N, long J, long K, float_type X1, float_type X2, float_type X3,
          float_type X4);
void PA(float_type E[]);
void P0(void);
void P3(float_type X, float_type Y, float_type *Z);
#define USAGE "usage: whetdc [-c] [loops]\n"

/*
        COMMON T,T1,T2,E1(4),J,K,L
*/
float_type T, T1, T2, E1[5];
int J, K, L;
...
IILOOP:
    ...
    */
    ...
    if (KIPS >= 1000.0)
        printf("C++ Converted float_type Precision Whetstones: %.1f MWIPS\n",
               KIPS / 1000.0);
    else
        printf("C++ Converted float_type Precision Whetstones: %.1f KWIPS\n",
               KIPS);
